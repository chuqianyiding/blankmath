...
const subtractionMNData = (state = initialState, action) => {
  switch (action.type) {
    case types.UPDATE_PROBLEM_SUBTRACTION_MN:
      return {
        ...state,
        problemNumber: action.payload
      };
    case types.UPDATE_FROM_VALUE_SUBTRACTION_MN:
      return {
        ...state,
        fromValue: action.payload,
        isFromValueError: getFormValueError(state, action.payload)
      };
    case types.UPDATE_TO_VALUE_SUBTRACTION_MN:
      return {
        ...state,
        toValue: action.payload,
        isToValueError: getToValueError(state, action.payload)
      };
    case types.UPDATE_RESTRICTION_SUBTRACTION_MN:
